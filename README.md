...
1. **MultiTriage**: 
    ...
    - Original Issue Report of the Open-Source ASP.NET Core Project. [[Source](https://github.com/dotnet/aspnetcore)]
...
3. **ADPTriage**: Bug reports from EclipseJDT \& GCC \& Mozilla OSS projects. [[Source](https://github.com/HadiJahanshahi/ADPTriage/tree/main/Toy_Example)]
4. **Towards more accurate severity prediction and fixer recommendation of software bugs**: Bug reports from Eclipse \& GCC \& Mozilla \& Netbeans \& OpenOffice OSS projects. [[Source](https://github.com/ProgrammerCJC/SPFR)]
5. **VTBA**: Bug reports from 13 popular GitHub projects (e.g., Angular.js, Rails, Elasticsearch). [[Source](https://github.com/TaskAssignment/VTBA)]
6. **Revisiting textual feature of bug-triage approach**: Bug reports from 6 OSS projects (e.g., Cassandra, Flex, Hbase). [[Source](https://github.com/lizx2017/textMyth)]
7. **S-DABT**: Bug reports from EclipseJDT \& GCC \& Mozilla \& OpenOffice OSS projects. [[Source](https://github.com/HadiJahanshahi/SDABT/tree/main/dat)]
8. **An empirical assessment of different word embedding and deep learning models for bug assignment**: Bug reports from EclipseJDT \& GCC \& Firefox OSS projects. [[Source](https://github.com/AI4BA/dl4ba)]
9. **Online app review analysis for identifying emerging issues**: User reviews of 6 popular apps. [[Source](https://github.com/ReMine-Lab/IDEA)]
10. **Investigating the criticality of user-reported issues through their relations with app rating**: Reviews and versions of Android apps\& code quality metrics. [[Source](https://github.com/sealuzh/user-satisfaction)]
11. **ART**: Microservice datasets \& failure cases. [[Source](https://github.com/bbyldebb/ART)]
12. **Severity-based triage of cybersecurity incidents using kill chain attack graphs**: Testbed data with Windows/Ubuntu hosts \& alerts \& logs from 5 attack scenarios. [[Source](http://dx.doi.org/10.5281/zenodo.14547668)]
13. **Listening to users' voice: Automatic summarization of helpful app reviews**: Reviews from 5 apps (e.g., eBay, Viber). [[Source](https://github.com/monsterLee599/SOLAR)]
14. **Automatically matching bug reports with related app reviews**: Problem reviews and bug reports from 4 open-source apps (e.g., Firefox, VLC). [[Source](https://mast.informatik.uni-hamburg.de/replication-packages/)]
15. **Classification of mobile application user reviews for generating tickets on issue tracking system**: Mobile app user review dataset with titles, descriptions, ratings, labeled as feature requests, problem discoveries, etc. [[Source](https://mast.informatik.uni-hamburg.de/app-review-analysis)]
16. **Triaging incoming change requests: Bug or commit history, or code authorship?**: Issue \& Commit Comment from ArgoUML, JEdit, MuCommander. [[Source](http://www.cs.wm.edu/semeru/data/icsm2012-authorship/)]
17. **Identifying Recurrent and Unknown Performance Issues**: Performance Metric Data Records. [[Source](http://www.dropbox.com/s/pj1miqu00ryoj9a/HMRF-kMedoid-EM.zip)]
18. **An artificial intelligence framework on software bug triaging, technological evolution, and future challenges: A review**: GitHub bug repository. [[Source](https://github.com/orgs/github/repositories)]
19. **Code quality control by bug report classification**: One-phase and Two-phase method from Camel, CloudStack, Geode and Hbase. [[Source](https://github.com/Ziba-Ghane/CQC.git)]
20. **On fusing artificial and convolutional neural network features for automatic bug assignments**: Sun Firefox, JDT, Netbeans, GUO Firefox, GCC datasets. [[Source](https://github.com/farhan-93/bugtriage)]
21. **$Triage_{Expert-Recency}$**: 
    - Mozilla Firefox project bug reports. [[Source](https://bugzilla.mozilla.org/describecomponents.cgi?product=Firefox)]
    - SeaMonkey project bug reports. [[Source](https://bugzilla.mozilla.org/describecomponents.cgi?product=SeaMonkey)]
22. **Jalal**: Eclipse project's Bugzilla bug report dataset with 48 features. [[Source](https://data.mendeley.com/datasets/t6d9y7yt54/1)]
23. **Crowdsourced Bug Triaging: Leveraging Q\&A Platforms for Bug Assignment**: Bug reports from 20 large GitHub projects. [[Source](https://github.com/alisajedi/BugTriaging)]
24. **The relation between developers’ communication and fix-Inducing changes: An empirical study**: Bug and communication data from Apache httpd, GNU GCC, Mozilla Firefox, and Xorg Xserver projects. [[Source](https://github.com/mlbresearch/talking-data)]
25. **GitBugs**: Bug report dataset from 9 open-source projects. [[Source](https://github.com/av9ash/gitbugs/)]
26. **Automatically Capturing Quality-Related Concerns in Bug Report Descriptions for Efficient Bug Triaging**: Bug reports from six OSS projects (Bugzilla \& Jira). [[Source](https://zenodo.org/record/6412840)]
27. **Automatically Prioritizing and Assigning Tasks from Code Repositories in Puzzle Driven Development**: Software development tasks (``puzzles'') extracted from industrial code repositories. [[Source](https://github.com/cqfn/pdd-data-analysis)]
28. **Separating the Wheat from the Chaff: Using Indexing and Sub-Sequence Mining Techniques to Identify Related Crashes During Bug Triage**: crash reports from large-scale OSS bug repositories. [[Source](https://github.com/kedjames/crashsearch-triage)]
29. **MSR2013**: Reported bugs extracted from the Eclipse and Mozilla projects.. [[Source](https://github.com/ansymo/msr2013-bug_dataset)]
30. **Bug Triaging**: Bugs tagged in the Eclipse dataset. [[Source](https://www.kaggle.com/datasets/monika11/bug-triagingbug-assignment/data)]
31. **Bugzilla-Mozilla**: System Bug report. [[Source](https://bugzilla.mozilla.org/home)]
32. **Eclipse**: Bugs reported \& Bugs changed. [[Source](https://bugs.eclipse.org/bugs/)]
33. **NetBeans**: NetBeans bug repository. [[Source](https://issues.apache.org/jira/projects/NETBEANS)]
34. **Apache**: Bugs reported \& Bugs changed. [[Source](https://issues.apache.org/jira/)]
35. **GCC**: Bugs reported \& Bugs changed. [[Source](http://gcc.gnu.org/bugzilla/)]
36. **Linux kernel**: Bugs reported \& Bugs changed. [[Source](https://bugzilla.kernel.org/)]
37. **Gentoo**: Bugs reported \& Bugs changed. [[Source](https://bugs.gentoo.org)]
...
6. **VTBA**: An vocabulary and time-aware bug-assignment approach by matching technical terms filtered via Stack Overflow and weighting historical fixes based on recency. [[Source](https://github.com/TaskAssignment/VTBA)]
...
8. **S-DABT**: An schedule and dependency-aware bug triage approach, which utilizes integer programming and machine learning techniques to assign bugs to suitable developers. [[Source](https://github.com/HadiJahanshahi/SDABT)]
...
11. **AutoAnalysis**: ERP Incident Reports &SplitSD4X groups incidents via subgroup discovery to summarize black box explanations. [[Source](https://github.com/RemilYoucef/split-sd4x)]
...
22. **Separating the Wheat from the Chaff: Using Indexing and Sub-Sequence Mining Techniques to Identify Related Crashes During Bug Triage**: An LSH- and sequential-pattern-mining–based approach for fingerprinting and clustering crash reports to identify duplicate and related bugs. [[Source](https://github.com/kedjames/crashsearch-triage)]
...
13. **Revisiting textual feature of bug-triage approach**
    Li, Zexuan and Zhong, Hao. *2021 36th IEEE/ACM International Conference on Automated Software Engineering (ASE)*. [[Paper](https://doi.org/10.1109/ASE51524.2021.9678863)]
14. **Automatic bug assignments without texts: a study**
  Li, Zexuan and Huang, Kaixin. *Frontiers of Computer Science*. [[Paper](https://www.researchgate.net/profile/Hao-Zhong-3/publication/365612461_Exploring_the_Key_Features_for_Automatic_Bug_Assignment_An_Empirical_Study/links/63e304ece2e1515b6b7b1db2/Exploring-the-Key-Features-for-Automatic-Bug-Assignment-An-Empirical-Study.pdf)]
...
3. **PCG: A joint framework of graph collaborative filtering for bug triaging**
...
5. **Improving bug triage with the bug personalized tossing relationship**
...
6. **A spatial-temporal graph neural network framework for automated software bug triaging**
...
5. **Not all bugs are the same: Understanding, characterizing, and classifying bug types**
...
6. **Deep learning-based software bug classification**
...
2. **Cost-aware triage ranking algorithms for bug reporting systems**
   Park, Jin-woo and Lee, Mu-Woong and Kim, Jinhan and Hwang, Seung-won and Kim, Sunghun. *Knowledge and Information Systems*. [[Paper](https://link.springer.com/article/10.1007/s10115-015-0893-9)]
3. **Knowledge guided hierarchical multi-label classification over ticket data**
...
4. **Efficient customer incident triage via linking with system incidents**
   Gu, Jiazhen and Wen, Jiaqi and Wang, Zijian and Zhao, Pu and Luo, Chuan and Kang, Yu and Zhou, Yangfan and Yang, Li and Sun, Jeffrey and Xu, Zhangwei and Qiao, Bo and Li, Liqun and Lin, Qingwei and Zhang, Dongmei, *Proceedings of the 28th ACM Joint Meeting on European Software Engineering Conference and Symposium on the Foundations of Software Engineering*. [[Paper](https://doi.org/10.1145/3368089.3417061)]
5. **Automatically matching bug reports with related app reviews**
...
6. **Art: A unified unsupervised framework for incident management in microservice systems**
   Sun, Yongqian and Shi, Binpeng and Mao, Mingyu and Ma, Minghua and Xia, Sibo and Zhang, Shenglin and Pei, Dan. *Proceedings of the 39th IEEE/ACM International Conference on Automated Software Engineering*. [[Paper](https://doi.org/10.1145/3691620.3695495)]
7. **Faultprofit: Hierarchical fault profiling of incident tickets in large-scale cloud systems**
   Huang, Junjie and Liu, Jinyang and Chen, Zhuangbin and Jiang, Zhihan and Li, Yichen and Gu, Jiazhen and Feng, Cong and Yang, Zengyin and Yang, Yongqiang and Lyu, Michael R. *Proceedings of the 46th International Conference on Software Engineering: Software Engineering in Practice*.[[Paper](
https://doi.org/10.1145/3639477.3639754)]
8. **Allhands: Ask me anything on large-scale verbatim feedback via large language models**
   Zhang, Chaoyun and Ma, Zicheng and Wu, Yuhao and He, Shilin and Qin, Si and Ma, Minghua and Qin, Xiaoting and Kang, Yu and Liang, Yuyi and Gou, Xiaoyu and others. *2025 IEEE 41st International Conference on Data Engineering (ICDE)*. [[Paper](https://doi.org/10.1109/ICDE65448.2025.00011)]
